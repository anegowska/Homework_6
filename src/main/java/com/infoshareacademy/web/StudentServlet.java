...
public class StudentServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        //Teachers
        Teacher teacher1 = new Teacher("62050727786","Anna", "Nowak",Arrays.asList(course1, course2));
        teacherDao.save(teacher1);
        Teacher teacher2 = new Teacher("85031627789","Adam", "Adamowski",Arrays.asList(course3, course1));
